...
class UnityGroup extends PosixGroup
{
    ...
    private function reenable(bool $send_mail = true): void
    {
        ...
        if ($send_mail) {
            $this->MAILER->sendMail($this->getOwnerMailAndManagerMails(), "group_reenabled", [
                "group_name" => $this->gid,
            ]);
        }
    ...
    public function cancelGroupJoinRequest(UnityUser $user, bool $send_mail = true): void
    {
        ...
        if ($send_mail) {
            $this->MAILER->sendMail(
                $this->getOwnerMailAndManagerMails(),
    ...
    /** @return string[] */
    public function getOwnerMailAndManagerMails(): array
    {
