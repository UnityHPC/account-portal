...
<p>
    ...
    They have lost acces to UnityHPC Platform services until they reset the inactivity timer by logging in to the <?php $portal_hyperlink; ?>.
</p>

<p>
    If this user is no longer actively participating in your group using UnityHPC Platform services,
    you might consider removing them from your group in the <?php $pi_hyperlink; ?>.
</p>
