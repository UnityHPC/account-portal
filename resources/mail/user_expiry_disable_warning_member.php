...
echo "
    The PI group $pi_group_gid is set to be disabled on $expiration_date because the group owner has been idle for too long.
    ...
    remind your PI to reset the inactivity timer by simply logging in to the $hyperlink.
";
if ($is_final_warning) {
